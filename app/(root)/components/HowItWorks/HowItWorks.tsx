import { howItWorks } from "./HowItWorks.data";
...
"
    ...
    "
        >
          ...
          <p
            className="
          text-xl text-slate-200 max-w-2xl mx-auto
          "
          >
          ...
          {howItWorks.map((step, index) => (
            <div className="relative group" key={index}>
              <div className="bg-purple-950 border rounded-2xl p-8 h-full hover:shadow-lg transition-all duration-400 hover:-translate-y-2">
                <div
                  className="
                flex items-center justify-center w-16 h-16 bg-linear-to-br from-primary/10 to-primary-glow/10 rounded-2xl mb-6 group-hover:scale-100 transition-transform
                "
                >
