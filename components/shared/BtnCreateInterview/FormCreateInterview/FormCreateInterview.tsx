...
import { levels, rols } from "./FormCreateInterview.data";
    ...
    <Form {...form}>
      ...
      >
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Iterview name" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  {levels.map((level, indexLevel) => (
                    <SelectItem key={indexLevel} value={level.value}>
                      <div className="flex items-center gap-2">
        ...
        <Button
          type="submit"
          className="
        w-full bg-linear-to-r from-purple-600 to-blue-600 font-bold py-3 px-6 rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all duration-300
        "
        >
          Start interview <Mic />
        </Button>
